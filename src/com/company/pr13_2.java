...
public class pr13_2 {
    ...
    static int calc(Calc_13_2 func, ArrayList<PenClass_13> penClass_13ArrayList, ArrayList<PaperClass_13> paperClass_13ArrayList, String searchComp){
        return func.calc(penClass_13ArrayList,paperClass_13ArrayList,searchComp);
    }
    public static void main(String[] args) {
        ...
        CalcClass calcCls = new CalcClass();
        ...
        System.out.println("Количество товаров заданного производителя: " + calc(calcCls::calc,penClass_13ArrayList,paperClass_13ArrayList,searchComp));
    }
}
